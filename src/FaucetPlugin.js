...
var faucet_1 = require("./faucet"); // Import the main faucet function
var database_1 = require("./database"); // Import Tableland database functions
var FaucetPlugin = /** @class */ (function (_super) {
    ...
    FaucetPlugin.prototype.init = function () {
    ...
    FaucetPlugin.prototype.requestEther = function (address, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var hasClaimed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, database_1.checkAddressInTableland)(address)];
                    case 1:
                        hasClaimed = _a.sent();
                        if (hasClaimed) {
                        ...
                        return [4 /*yield*/, (0, faucet_1.requestEther)(address, amount)];
                    case 2:
                        // Send Ether to the address
                        _a.sent();
                        // Update the Tableland record to mark the address as having claimed Ether
                        return [4 /*yield*/, (0, database_1.updateTablelandRecord)(address)];
                    case 3:
                        // Update the Tableland record to mark the address as having claimed Ether
                        _a.sent();
